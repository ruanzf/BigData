...
public class MergeRecord implements IRichBolt {
    ...
    public void execute(Tuple input) {
        ...
        if (input.getSourceComponent().equals(SequenceTopologyDef.CUSTOMER_BOLT_NAME)) {
            LOG.info("MergeRecord customer tupleId: " + tupleId);
            customer = pair;
            customerTuple = input;
            ...
            LOG.info("MergeRecord trade tupleId: " + tupleId);
            trade = pair;
            tradeTuple = input;
    ...
    public void cleanup() {
        tpsCounter.cleanup();
        LOG.info("MergeRecord tradeSum:" + tradeSum + ", cumsterSum:" + customerSum);
        LOG.info("MergeRecord cleanup");
    }
