...
public class TotalCount implements IRichBolt {
    ...
    public void cleanup() {
        tpsCounter.cleanup();
        LOG.info("TotalCount tradeSum:" + tradeSum + ", cumsterSum:" + customerSum);
        LOG.info("TotalCount cleanup");
    }
